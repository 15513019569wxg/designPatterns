...
public class ConcreteMediator extends Mediator {
    ...
    public void GetMessage(int stateChange, String colleagueName) {
        ...
        if (colleagueMap.get(colleagueName) instanceof Alarm) {
            ...
            } else if (stateChange == 1) ((TV) colleagueMap.get(interMap.get("TV"))).StopTv();
        } else //如果是以窗帘发出的消息，这里处理...
            if (colleagueMap.get(colleagueName) instanceof CoffeeMachine) ((Curtains) (colleagueMap.get(interMap.get("Curtains")))).UpCurtains();
            else if (!(colleagueMap.get(colleagueName) instanceof TV)) colleagueMap.get(colleagueName);
